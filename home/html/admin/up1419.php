...
if (isset($_GET['id'])) {
        ...
        if ($_FILES['image']['error'] == UPLOAD_ERR_OK) {
            ...
            if (in_array($_FILES['image']['type'], $allowedTypes)) {
                ...
                if (move_uploaded_file($imageTmpName, $imagePath)) {
                    ...
                    $query = "UPDATE `t1419` SET name=?, image=?, price=? WHERE id=?";
            ...
            $query = "UPDATE `t1419` SET name=?, price=? WHERE id=?";
            $stmt = mysqli_prepare($cn, $query);
    ...
    $query = "SELECT * FROM `t1419` WHERE id=?";
    $stmt = mysqli_prepare($cn, $query);
...
<body>
    <div class="container">
        ...
        <a class="back-link" href="1419a.php">Back to List</a>
    </div>
</body>
</html>
